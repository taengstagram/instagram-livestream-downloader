# Instagram Live Stream Downloader [![Release](https://img.shields.io/badge/latest_release-v0.3.1-ff4980.svg)](https://github.com/taengstagram/instagram-livestream-downloader/releases)
...
```bash
pip install git+https://git@github.com/taengstagram/instagram-livestream-downloader.git@0.3.1 --process-dependency-links
```
...
```
INSTAGRAM LIVESTREAM DOWNLOADER (v0.3.1)
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
...
The latest version is __v0.3.1__. To update your copy:

```bash
pip install git+https://git@github.com/taengstagram/instagram-livestream-downloader.git@0.3.1 --process-dependency-links --upgrade
```
